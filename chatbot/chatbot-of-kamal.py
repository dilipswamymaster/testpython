'''
Simple chatbot actor kamal hasan
'''
...
st.markdown("<h1 style='text-align: center; color: red;'> Simple Chatbot about Actor Kamal Hasan </h1>", unsafe_allow_html=True)
...
g = Goose()
url = 'https://en.wikipedia.org/wiki/Kamal_Haasan'
...
reply_dict = { 'Who are you?': 'I am a chatbot and I will answer your questions about Actor Kamal Hasan ', 'Hey': 'Hi there! Tell me how can I assist you ', 'Hello': 'Hello, how may I assist you?',
              'Hi': 'Hey! How can I help you?', 'How can you help me?': 'I can assist you with questions on chatGPT','who are you?': 'I am a chatbot and I will answer your questions about ChatGPT ', 'hey': 'Hi there! Tell me how can I assist you ', 'hello': 'Hello, how may I assist you?',
              'hi': 'Hey! How can I help you?', 'how can you help me?': 'I can assist you with questions on chatGPT','what is your source of information': 'Its Wikipedia'}
...
if "history" not in st.session_state:
    st.session_state.history = [
          {"message" :'Hello! I am a chatbot and I will answer your questions about Kamal Hasan',
           'is_user' : True
           }]


#msg_history=[]
def generate_answer(in_key):
    #i=0
...
rand_input_key=f"input_text_{random.randint(0, 999)}"
